...
def volatility_minimization(order_book_ids,date,cov_estimator="shrinkage",window=126,bounds={},industryConstraints={},styleConstraints={},benchmarkOptions=None):
    ...
    benchmark = benchmarkOptions.get("benchmark")
    ...
    _index_components = index_components(benchmark, date=date) if benchmark is not None else []
    ...
    return optimized_weight,res.status,subnew_returns,suspended_returns
