...
def filter_suspended_stocks(stocks,date):
    """
    :param stocks:股票列表
    :param date: 检验停牌日期
    :return:
...
def noisy_stocks_filter(stocks,date,subnewThres=350,percentileThres=5):
    ...
    filtered_stocks = list(set(stocks)-set(st_stocks)-set(subnew_stocks))
    filtered_stocks = filter_suspended_stocks(filtered_stocks, date)
